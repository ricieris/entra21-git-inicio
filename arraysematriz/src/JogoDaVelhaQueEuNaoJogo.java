...
//COPIADO DA INTERNET PARA TESTE
          public class JogoDaVelhaQueEuNaoJogo {
              private int jogo[][] = new int[3][3];
              public JogoDaVelhaQueEuNaoJogo() {
                  for (int i = 0; i < 3; i++) {
                      for (int j = 0; j < 3; j++) {
                          jogo[i][j] = 0;
                      }
              ...
              public static void main(String[] argumentos) {
                  ...
                  JogoDaVelhaQueEuNaoJogo jogo = new JogoDaVelhaQueEuNaoJogo();
                  int jogador = 1;
